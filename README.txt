...
2.4
  we need to structuralize the signatures which might be used in the standalone signature for symbol tables we would like to define. Once we structuralize the signatures, we could directly use their member values, functions or exceptions in the signature we're currently defining.
